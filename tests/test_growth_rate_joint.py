...
from mioflow import TimeSeriesDataset, ODEFunc, GrowthRateModel, train_mioflow, infer
...
def main():
    ...
    print("======== Version A: Direct Joint Training ========")
    print("Training MIOFlow with Growth Rate concurrently...")
    ...
    plt.title('MIOFlow with Growth Rate (Joint) - Training Losses')
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.legend()
    plt.grid(True, alpha=0.3)
    plt.yscale('log')
    plt.savefig('tests/growth_rate_joint_losses.png')
    print("Saved loss plot to tests/growth_rate_joint_losses.png")
    ...
    plt.title('MIOFlow Trajectories (Thickness ~ Predicted Mass - Joint)')
    plt.xlabel('Feature 1')
    plt.ylabel('Feature 2')
    plt.grid(True, alpha=0.3)
    plt.savefig('tests/growth_rate_joint_trajectories.png')
    print("Saved trajectory plot to tests/growth_rate_joint_trajectories.png")
    ...
    plt.title('Predicted Growth Rate Field (Joint)')
    plt.xlabel('Feature 1')
    plt.ylabel('Feature 2')
    plt.grid(True, alpha=0.3)
    plt.savefig('tests/growth_rate_joint_all_mass.png')
    print("Saved all mass plot to tests/growth_rate_joint_all_mass.png")
